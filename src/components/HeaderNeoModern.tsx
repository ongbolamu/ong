...
import { 
  ...
  Award, Target, Heart, Eye, Calendar
} from 'lucide-react';

export default function HeaderNeoModern() {
                    ...
                    <Link href={item.href}>
                      ...
                      >
                        ...
                        <div className="w-8 h-8 rounded-xl bg-gray-100 group-hover:bg-orange-100 flex items-center justify-center group-hover:scale-110 transition-transform">
                          <Icon className="w-4 h-4 text-gray-600 group-hover:text-[#ff6219]" />
                        </div>
                              ...
                              >
                                <Link href={subItem.href}>
                                  <motion.div 
                                    ...
                                    whileHover={{ x: 5 }}
                                  >
                                    <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-purple-100 to-blue-100 flex items-center justify-center group-hover:scale-110 transition-transform">
                                      <SubIcon className="w-4 h-4 text-purple-600" />
                                    </div>
